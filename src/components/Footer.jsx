...
const Footer = () => {
  ...
  return (
   ...
   <div className='footer-top-row-img-container'><img src={map}/></div><a href='https://www.google.com/maps/place/Clackamas+County,+OR/@45.1736945,-122.2597459,10z/data=!3m1!4b1!4m5!3m4!1s0x54957cbd38c5ef17:0x6525907c67d689ae!8m2!3d45.2023855!4d-122.1188945' target='_blank'>Clackamas County, OR</a>
    </div>
    <div className='footer-div'>
    <div className='footer-top-row-img-container'><img src={email}/></div><a href='mailto:adam.algatt@gmail.com'>Email Me</a>
    </div>
    <div className='footer-div'>
    <div className='footer-top-row-img-container'><img src={phone}/></div><a href="tel:503-754-3968">
    +1 503-555-5555</a>
    </div>
    </div>
